      ...
      >
        <div className="flex flex-col justify-center items-center h-full text-center text-white py-24 px-4 sm:px-8">
          ...
          <p className="text-lg sm:text-xl leading-relaxed max-w-4xl mb-8">
            At CoolCuts , we show your skin, hair, and body the care and
            attention they deserve. Your hair reflects your personality, and our
            professionals are here to enhance your unique style. Book now and
            let us cut, shave, and color your hair to perfectly complement your
            facial features.
          </p>
          <Link
            to="/book-appointment"
